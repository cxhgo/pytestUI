...
class Baziyinyuan(Base):
    '''定义所需要的元素'''
    ele_name = ('xpath','//*[@id="root"]/div[2]/div[2]/div[1]/div[1]/div/input')  # 姓名输入框
    ele_birthday = ('xpath','//*[@id="root"]/div[2]/div[2]/div[1]/div[3]/div')  # 出生日期输入框
    ele_ljcs = ('xpath','//*[@id="root"]/div[2]/div[2]/div[2]/div')  # 立即测算按钮
